...
@dp.message(lambda message: message.text == "❤️ Planes")
...
@dp.message(lambda message: message.text == "🚀 PERÍODO DE PRUEBA 🚀")
...
@dp.message(lambda message: message.text == "👤 Suscripción")
async def help(message: types.Message):
    await message.answer(text=subcribe, parse_mode="HTML")

@dp.message(lambda message: message.text == "🎁 Ingresar código promocional")
async def enter_promo_code(message: types.Message):
    await message.answer("Ingresa el código promocional:")


@dp.message(lambda message: message.text == "💌 Mis contactos")   
...
@dp.message()
async def enter_promo_code(message: types.Message):
    await message.answer("Código promocional no encontrado")
